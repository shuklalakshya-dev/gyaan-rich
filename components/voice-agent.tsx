        ...
        <CardContent className="space-y-6">
          ...
          <div className="flex justify-center">
            <button
              ...
              className={cn(
                "relative w-32 h-32 rounded-full transition-all duration-300 overflow-hidden border-4",
                isListening 
          ...
          {transcript && (
            <div className="space-y-2">
              <p className="text-sm font-semibold text-yellow-400">You said:</p>
              <div className="p-4 bg-zinc-900 border border-zinc-800 rounded-lg">
                <p className="text-base text-zinc-200">{transcript}</p>
              </div>
            </div>
          )}
          ...
          {response && (
            <div className="space-y-2">
              <p className="text-sm font-semibold text-yellow-400">AI Response:</p>
              <div className="p-4 bg-gradient-to-br from-yellow-400/10 to-yellow-600/10 border border-yellow-400/30 rounded-lg">
                <p className="text-base text-zinc-100">{response}</p>
              </div>
            </div>
          )}
          ...
          {(transcript || response) && !isListening && !isProcessing && (
            <div className="flex justify-center pt-4">
              <Button 
                variant="outline" 
                onClick={reset} 
                className="bg-zinc-900 border-yellow-400 text-yellow-400 hover:bg-yellow-400 hover:text-black transition-all"
              >
